...
public class NotificationError extends javax.swing.JDialog {

    public NotificationError(java.awt.Frame parent, boolean modal, int miliseconds, String title, String msg) {
        super(parent, modal);
        initComponents();

    }

    private NotificationError(JFrame jFrame, boolean b) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotificationError.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NotificationError dialog = new NotificationError(new javax.swing.JFrame(), true);
