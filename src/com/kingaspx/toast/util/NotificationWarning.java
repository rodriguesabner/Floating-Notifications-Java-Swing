...
public class NotificationWarning extends javax.swing.JDialog {

    public NotificationWarning(java.awt.Frame parent, boolean modal, int miliseconds, String title, String msg) {
        super(parent, modal);
        initComponents();

    }

    private NotificationWarning(JFrame jFrame, boolean b) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotificationWarning.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NotificationWarning dialog = new NotificationWarning(new javax.swing.JFrame(), true);
